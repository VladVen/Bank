...
const Oshad = () => {
    ...
    return(
        <div className="calc">
            ...
            <div>
                Процентна ставка: 5.6%
            </div>
            <div>
                <button onClick= {() => {
                    const BorrowMoney = Math.round((sumElement.current.value*(5.6/12)*(1+(5.6/12))^timeElement.current.value)/(((1+(5.6/12))^timeElement.current.value)-1)); 
