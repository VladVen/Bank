...
const Pumb = () => {
    ...
    return(
        <div className="calc">
            ...
            <div>
                Процентна ставка: 1.7%
            </div>
            <div>
                <button onClick= {() => {
                    const BorrowMoney = Math.round((sumElement.current.value*(1.7/12)*(1+(1.7/12))^timeElement.current.value)/(((1+(1.7/12))^timeElement.current.value)-1)); 
